...
printTestTree = testGroup "Print.hs unit tests" $
  [testGroup "flatPrint" [
      testCase "Empty SList" $ flatPrint printer (SList () [] :: Sexp) @?= "()",
      testCase "Singleton SList" $ flatPrint printer (SList () [SAtom 1] :: Sexp) @?= "(1)",
      testCase "SList 1/3" $ flatPrint printer (SList () [SAtom 1, SAtom 2, SAtom 3] :: Sexp) @?= "(1 2 3)",
      testCase "SList 2/3" $ flatPrint printer (SList () [SAtom 1, SList () [SAtom 2], SAtom 3] :: Sexp) @?= "(1 (2) 3)",
